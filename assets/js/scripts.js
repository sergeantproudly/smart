...
(function (t) {
    ...
    t.position = {
      ...
      return v = s(_), _[0].preventDefault && (n.at = "left top"), p = v.width, f = v.height, m = v.offset, g = t.extend({}, m), t.each(["my", "at"], function () {
        ...
        var s,
            ...
            D = c + v + i(this, "marginBottom") + y.height,
            C = t.extend({}, g),
            T = e(k.my, h.outerWidth(), h.outerHeight());
        "right" === n.my[0] ? C.left -= l : "center" === n.my[0] && (C.left -= l / 2), "bottom" === n.my[1] ? C.top -= c : "center" === n.my[1] && (C.top -= c / 2), C.left += T[0], C.top += T[1], s = {
          marginLeft: d,
          marginTop: v
  ...
  t.extend(s.prototype, {
    ...
    _generateHTML: function _generateHTML(t) {
      ...
      if (0 > Z && (Z += 12, te--), Q) for (e = this._daylightSavingAdjust(new Date(Q.getFullYear(), Q.getMonth() - U[0] * U[1] + 1, Q.getDate())), e = G && G > e ? G : e; this._daylightSavingAdjust(new Date(te, Z, 1)) > e;) {
        Z--, 0 > Z && (Z = 11, te--);
      }
      ...
      for (t.drawMonth = Z, t.drawYear = te, i = this._get(t, "prevText"), i = K ? this.formatDate(i, this._daylightSavingAdjust(new Date(te, Z - X, 1)), this._getFormatConfig(t)) : i, s = this._canAdjustMonth(t, -1, te, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w") + "'>" + i + "</span></a>" : q ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w") + "'>" + i + "</span></a>", n = this._get(t, "nextText"), n = K ? this.formatDate(n, this._daylightSavingAdjust(new Date(te, Z + X, 1)), this._getFormatConfig(t)) : n, o = this._canAdjustMonth(t, 1, te, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e") + "'>" + n + "</span></a>" : q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e") + "'>" + n + "</span></a>", a = this._get(t, "currentText"), r = this._get(t, "gotoCurrent") && t.currentDay ? J : Y, a = K ? this.formatDate(a, r, this._getFormatConfig(t)) : a, h = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", l = B ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (j ? h : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (j ? "" : h) + "</div>" : "", c = parseInt(this._get(t, "firstDay"), 10), c = isNaN(c) ? 0 : c, u = this._get(t, "showWeek"), d = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), m = this._get(t, "monthNamesShort"), g = this._get(t, "beforeShowDay"), v = this._get(t, "showOtherMonths"), _ = this._get(t, "selectOtherMonths"), b = this._getDefaultDate(t), y = "", k = 0; U[0] > k; k++) {
        for (x = "", this.maxRows = 4, D = 0; U[1] > D; D++) {
          ...
          for (M += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === k ? j ? o : s : "") + (/all|right/.test(T) && 0 === k ? j ? s : o : "") + this._generateMonthYearHeader(t, Z, te, G, Q, k > 0 || D > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead>" + "<tr>", I = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; 7 > w; w++) {
            S = (w + c) % 7, I += "<th scope='col'" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + ">" + "<span title='" + d[S] + "'>" + p[S] + "</span></th>";
          }
          ...
          for (M += I + "</tr></thead><tbody>", P = this._getDaysInMonth(te, Z), te === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, P)), N = (this._getFirstDayOfMonth(te, Z) - c + 7) % 7, A = Math.ceil((N + P) / 7), H = $ ? this.maxRows > A ? this.maxRows : A : A, this.maxRows = H, z = this._daylightSavingAdjust(new Date(te, Z, 1 - N)), O = 0; H > O; O++) {
            for (M += "<tr>", E = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(z) + "</td>" : "", w = 0; 7 > w; w++) {
              W = g ? g.apply(t.input ? t.input[0] : null, [z]) : [!0, ""], F = z.getMonth() !== Z, L = F && !_ || !W[0] || G && G > z || Q && z > Q, E += "<td class='" + ((w + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (F ? " ui-datepicker-other-month" : "") + (z.getTime() === C.getTime() && Z === t.selectedMonth && t._keyEvent || b.getTime() === z.getTime() && b.getTime() === C.getTime() ? " " + this._dayOverClass : "") + (L ? " " + this._unselectableClass + " ui-state-disabled" : "") + (F && !v ? "" : " " + W[1] + (z.getTime() === J.getTime() ? " " + this._currentClass : "") + (z.getTime() === Y.getTime() ? " ui-datepicker-today" : "")) + "'" + (F && !v || !W[2] ? "" : " title='" + W[2].replace(/'/g, "&#39;") + "'") + (L ? "" : " data-handler='selectDay' data-event='click' data-month='" + z.getMonth() + "' data-year='" + z.getFullYear() + "'") + ">" + (F && !v ? "&#xa0;" : L ? "<span class='ui-state-default'>" + z.getDate() + "</span>" : "<a class='ui-state-default" + (z.getTime() === Y.getTime() ? " ui-state-highlight" : "") + (z.getTime() === J.getTime() ? " ui-state-active" : "") + (F ? " ui-priority-secondary" : "") + "' href='#'>" + z.getDate() + "</a>") + "</td>", z.setDate(z.getDate() + 1), z = this._daylightSavingAdjust(z);
            }
  ...
  t.effects.define("blind", "hide", function (e, i) {
    ...
    for (t.effects.createPlaceholder(a), o = a.css(g), u || (u = a["top" === g ? "outerHeight" : "outerWidth"]() / 3), l && (n = {
      opacity: 1
    }, n[g] = o, a.css("opacity", 0).css(g, v ? 2 * -u : 2 * u).animate(n, f, m)), h && (u /= Math.pow(2, d - 1)), n = {}, n[g] = o; d > _; _++) {
...
function initElements(element) {
  ...
  $element.find('.js-date').each(function (index, input) {
    ...
    if (minYear) datepicker_options.minDate = '01.01.' + minYear;else minYear = 'c-10';
    var maxYear = $(input).attr('data-max-year');
    if (maxYear) datepicker_options.maxDate = '01.01.' + maxYear;else maxYear = 'c+10';
    ...
    $(input).next('i').click(function () {
      $(this).prev('input').datepicker('show'); //initElements($('#ui-datepicker-div'));
    });
  });
...
function showModal(modal_id, dontHideOthers) {
  var $modal = $('#' + modal_id);
  if (typeof dontHideOthers == 'undefined' || !dontHideOthers) $('.modal-wrapper:visible').not($modal).attr('data-transparent', true).stop().animate({
    'opacity': 0
    ...
    $.each(block.childNodes, function (i, node) {
      if (node.nodeType != 3) {
        ...
        if (typeof range != 'undefined') {
          ...
          if (typeof size != 'undefined' && typeof size[0] != 'undefined' && _typeof(size[0]['width'] != 'undefined')) w_child += size[0]['width'];
        }
      }
    });
          ...
          swipeStatus: function swipeStatus(event, phase, direction, distance) {
            ...
            if (phase === $.fn.swipe.phases.PHASE_START) {
              ...
              if (direction == 'left') {
                ...
                if (scroll_value_new >= scroll_max) $(this).addClass('scrolled-full');else $(this).removeClass('scrolled-full');
...
function editableSelectReinit(select) {
  if (typeof select == 'string') var $select = $('#' + select);else $select = $(select);
...
function _scrollTo(target, offset) {
  ...
  if (typeof offset == 'undefined') offset = Math.round($(target).outerHeight() / 2) - Math.round(wh / 2);else if (offset === false) offset = 0;
  $('html,body').animate({
...
function checkEmail(fld) {
  ...
  var str = fld.value;
  if (!str || reg.test(str)) return true;else {
    $(fld).addClass('err');
    return false;
  }
}
...
function checkPassword(fld) {
  var reg = /[A-z0-9\.]+/;
  var str = fld.value;
  if (reg.test(str)) return true;else {
    $(fld).addClass('err');
    return false;
  }
}
...
function checkTheSame(fld) {
  ...
  if (fld.value == fld2.value) return true;else {
    $(fld).addClass('err');
    return false;
  }
}
...
function msgUnset(node, animate) {
  if (!animate) $(node).prev('.wait, .error, .message, .success').remove();else $(node).prev('.wait, .error, .message, .success').stop().slideUp(500, function () {
    $(this).remove();
  });
}
"use strict";
...
var __animationSpeed = 350; // PAGE OPENING AND PRELOADING

function Preloader() {
  var fullPreload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  var self = this;
  ...
  this.pageOpen = function () {
    self.$preloader.addClass('release').delay(self.openingSpeed - self.fadeoutSpeed).fadeOut(self.fadeoutSpeed);
    $(window).trigger('opening');
  };

  this.pageClose = function (callback) {
    self.$preloader.show().removeClass('release');
    setTimeout(function () {
      callback();
    }, self.openingSpeed);
...
$(document).ready(function () {
  $.fn.lightTabs = function () {
    var showTab = function showTab(tab, saveHash) {
      ;
    ...
    var initTabs = function initTabs() {
      ...
      $(tabs).find('a').each(function (i, tab) {
        ...
        if (i == 0) showTab(tab);else $($(tab).attr('href')).hide();
      });
      $(tabs).swipe({
        swipeStatus: function swipeStatus(event, phase, direction, distance) {
          var offset = distance;
  ...
  $('a[href]').click(function (e) {
    if (window.pagePreloader) {
      if (!$(this).parent().hasClass('has-child') && !$(this).hasClass('js-lightbox') && !$(this).hasClass('js-modal-link') && $(this).attr('href').substr(0, 7) != 'mailto:' && $(this).attr('href').substr(0, 4) != 'tel:' && $(this).attr('target') != '_blank') {
        e.preventDefault();
  ...
  var isOverheight = function isOverheight() {
    return !__isMobile ? $('header').outerHeight() > $(window).height() : $('nav').outerHeight() + $('#logo').outerHeight(true) > $(window).height();
  };
  ...
  $('.js-slider').each(function (i, slider) {
    ...
    if (mobile) {
      if (mobile === 'true' && __isMobile || mobile === 'middle' && __isMobileTabletMiddle || mobile === 'small' && __isMobileTabletSmall || mobile === 'mobile' && __isMobileSmall) {
        $(slider).slick({
    ...
    $('#bl-vacancies>ul>li').each(function (i, li) {
      $(li).children('.toggler').click(function () {
        ...
        if (!$li.hasClass('opened')) {
          ...
          }, __animationSpeed, 'easeInOutCubic', function () {
  ...
  function sendFeedback(form) {
    ...
    if ($(form.agree).prop('checked')) {
      ...
      if (checkElements([form.tel, form.text], [{
        1: true
      }, {
        1: true
      }])) {
      ...
      } else {//msgSetError(form.tel, 'Введите, пожалуйста, телефон');
      }
    } else {// agreement
      }
  } // MEDIA GALLERY VIDEO
